...
CREATE_GROUP(MEAS_ECG_REQUIREDSAMPLERATE_16,
...
const DescriptorItem_t s_possibleSbemItems[] = {
    ...
    {WHITEBOARD_TIME, "<PTH>Whiteboard.Time+\n<FRM>int64,nillable=4294967295"},
...
const DescriptorGroup_t s_possibleSbemGroups[] = {
    ...
    MEAS_ECG_REQUIREDSAMPLERATE_16_Group,
...
const SbemResID2GrpIdMapping s_sbemResID2GrpIdMap[] = {
    ...
    { WB_RES::LOCAL::MEAS_ECG_REQUIREDSAMPLERATE::LID,  + 4 +  (16)  * (0  + 4 ) , &MEAS_ECG_REQUIREDSAMPLERATE_16_Group },
